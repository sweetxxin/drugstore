...
<script>
    $(document).ready(function () {
        ...
        $('#left-nav-1-child')
                .append("<dd><a style='color:white;background: #009688;'  href='/admin/page/first-category-setting'>第一级分类</a>" + "</dd>")
    ...
    layui.use(['table','layer'], function(){
        ...
        table.render({
            elem: '#productTable'
            ,height: 420
            ,url: '/product/category/1/list' //数据接口
            ,page: true //开启分页
            ...
            switch(obj.event){
                case 'add':
                    layer.open({
                        ...
                        type:2,
                        area:['676px','300px'],
                        content:"/admin/page/popCategory?type=1"
                            });
                    break;
            };
        });
