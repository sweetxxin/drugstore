...
<script type="text/html" id="operation">
    ...
    <a class="layui-btn layui-btn-danger layui-btn-xs" lay-event="on">上架</a>
</script>
...
<script>
    $(document).ready(function () {
        ...
        $('#left-nav-1-child')
                ...
                .append("<dd><a style='color:white;background: #009688;' href='/admin/page/product-off'>下架商品</a>" + "</dd>")
    ...
    layui.use('table', function(){
        ...
        table.render({
            elem: '#productTable'
            ,height: 420
            ,url: '/admin/product/off/list' //数据接口
            ,page: true //开启分页
            ...
            toolbar: 'default'
            ,cols: [[ //表头
                {field: 'productNo', title: '商品编号', width:110, sort: true, fixed: 'left'}
                ,{field: 'name',edit:true, title: '商品名称', width:230}
                ,{field: 'stock', edit:false,title: '库存', width: 80}
                ,{field: 'keywords', edit:true,title: '关键词', width: 180}
                ,{field: 'description',edit:true, title: '描述', width:230}
                ,{title:"操作",toolbar:"#operation",width:180,fixed:"right"}
            ]]
