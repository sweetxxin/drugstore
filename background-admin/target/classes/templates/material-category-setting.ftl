...
<script>
    $(document).ready(function () {
        ...
        $('#left-nav-1-child')
                ...
                .append("<dd><a style='color:white;background: #009688;'  href='/admin/page/material-category-setting'>药品原料</a>" + "</dd>")
                .append("<dd><a href='/admin/page/use-category-setting'>症状/用途</a>" + "</dd>")
                .append("<dd><a href='/admin/page/brand-category-setting'>药品品牌</a>" + "</dd>")
    })
    //JavaScript代码区域
    ...
    layui.use(['table','layer'], function(){
        ...
        table.render({
            elem: '#productTable'
            ,height: 420
            ,url: '/product/category/20/list' //数据接口
            ,page: true //开启分页
            ...
            switch(obj.event){
                case 'add':
                    layer.open({
                        ...
                        type:2,
                        area:['676px','300px'],
                        content:"/admin/page/popCategory?type=20"
                            });
                    break;
            };
        });
