...
<script>
    $(document).ready(function () {
        ...
        $('#left-nav-1-child')
                ...
                .append("<dd><a style='color:white;background: #009688;' href='/admin/page/use-category-setting'>症状/用途</a>" + "</dd>")
    ...
    layui.use('table', function(){
        ...
        table.render({
            elem: '#productTable'
            ,height: 420
            ,url: '/product/category/30/list' //数据接口
            ,page: true //开启分页
            ...
            switch(obj.event){
                case 'add':
                    layer.open({
                        ...
                        type:2,
                        area:['676px','400px'],
                        content:"/admin/page/popCategory?type=30"
                    });
                    break;
                case 'delete':
                    layer.msg('删除');
