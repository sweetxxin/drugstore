...
<script>
    $(document).ready(function () {
        ...
        $('#left-nav-1-child')
                .append("<dd><a  href='/admin/page/inform-new'>新通知</a>" + "</dd>")
                .append("<dd><a  style='color:white;background: #009688;' href='/admin/page/inform-read'>已读通知</a>" + "</dd>")
    })
